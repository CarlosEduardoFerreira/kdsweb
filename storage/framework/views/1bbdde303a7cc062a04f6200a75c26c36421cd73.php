            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                	...
                	<?php if(auth()->user()->hasRole('administrator')) { ?>
                        <li>
                            <a href="<?php echo e(route('admin.resellers', ['adminId' => '0'])); ?>">
                    ...
                    <?php if(auth()->user()->hasRole('administrator') || auth()->user()->hasRole('reseller')) { ?>
                        <li>
                            <a href="<?php echo e(route('admin.storegroups', ['resellerId' => '0'])); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.stores', ['storegroupId' => '0'])); ?>">
                    ...
                    <!-- 
                        <li>
                            <a href="<?php echo e(route('admin.users', ['user' => '0'])); ?>">
