                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="licenses_quantity" type="number" class="form-control col-md-7 col-xs-12"
                               name="licenses_quantity" value="<?php echo e($user->licenses_quantity); ?>" required>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="roles" name="roles[]" class="select2" style="width: 100%" autocomplete="off">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($user->roles->find($role->id)): ?> selected="selected" <?php endif; ?> value="<?php echo e($role->id); ?>"><?php echo e($role->display); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
