...
class StoreGroupController extends Controller
{
    ...
    public function index(Request $request, string $resellerId)
    {
        ...
        $users = Controller::filterUsers(3, $resellerId);

        return view('admin.storegroups.index', ['users' => $users]);
    }
    ...
    {
        return view('admin.storegroups.show', ['user' => $user]);
    }
    ...
    {
        return view('admin.storegroups.edit', ['user' => $user, 'roles' => Role::get()]);
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->intended(route('admin.storegroups'));
    }
