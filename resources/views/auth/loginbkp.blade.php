        ...
        <div class="login_wrapper">
            <div class="animate form login_form">
                <section class="login_content">
                    ...
                    <div style="width:100%; bottom:50%;background:#cde;">
                        <table style="width:100%;background:#red;">
                            <tr style="background:#fda;">
                                <td style="background:#edf;"> <img src="kds_lines.png" style="height:70px;width:30%;"/> </td>
                                <td style="background:#dfe;"> <img src="kds_logo.png" style="width:170px;"/> <td>
                            </tr>
                        </table>
                    </div>
